...
if [ $vendor = $BRCM ]; then
	...
	if [ $brcm_symlink = y ]; then
		/system/bin/ln -s /system/vendor/firmware/bcm4354a1/fw_bcm4354_ag.bin /data/misc/wifi/firmware/fw_bcmdhd.bin
		/system/bin/ln -s /system/vendor/firmware/bcm4354a1/fw_bcm4354_ag_apsta.bin /data/misc/wifi/firmware/fw_bcmdhd_apsta.bin
		/system/bin/ln -s /system/vendor/firmware/bcm4354a1/fw_bcm4354_ag_p2p.bin /data/misc/wifi/firmware/fw_bcmdhd_p2p.bin
		/system/bin/ln -s /system/vendor/firmware/bcm4354a1/fw_bcm43241_ag.bin /data/misc/wifi/firmware/fw_bcm43241_ag.bin
		if [ $chip = "43341" ]; then
